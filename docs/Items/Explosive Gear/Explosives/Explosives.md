...
### Grenades
When throwing a grenade, treat it as a simple ranged weapon (range 20/60). Grenades can also be used as ammunition for a grenade launcher or handheld launcher. When thrown at its long range, affected creatures have advantage on the save if it comes from the explosive itself.
### Rockets
