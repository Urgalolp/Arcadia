...
Some activities can be done with more ease when using this tool, and some can only be done with this tool, such as the exceptions (but not their DCs, because fuck you) below.
